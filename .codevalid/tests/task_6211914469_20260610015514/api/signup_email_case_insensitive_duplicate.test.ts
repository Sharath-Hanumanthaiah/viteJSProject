...
async function loadServer(): Promise<TestContext> {
  ...
  try {
    ...
    await import("../../../backend/server.js?case=signup_email_case_insensitive_duplicate");
...
describe("signup_email_case_insensitive_duplicate", () => {
  ...
  it("detects duplicate emails case-insensitively", async () => {
