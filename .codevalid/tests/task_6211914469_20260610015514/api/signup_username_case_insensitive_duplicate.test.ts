...
async function loadServer(): Promise<TestContext> {
  ...
  try {
    ...
    await import("../../../backend/server.js?case=signup_username_case_insensitive_duplicate");
...
describe("signup_username_case_insensitive_duplicate", () => {
  ...
  it("detects duplicate usernames case-insensitively", async () => {
