...
async function loadServer(): Promise<TestContext> {
  ...
  try {
    ...
    await import("../../../backend/server.js?case=signup_missing_all_required_fields");
...
describe("signup_missing_all_required_fields", () => {
  ...
  it("returns 400 for an empty signup body", async () => {
