...
RESPONSE_FILE="/tmp/create_event_with_valid_date_range_response_${CASE_SUFFIX}.json"
VERIFY_FILE="/tmp/create_event_with_valid_date_range_verify_${CASE_SUFFIX}.json"
EVENT_ID=""
ATTENDEE_NAME="valid-registrant-${CASE_SUFFIX}"
ATTENDEE_EMAIL="valid-registrant-${CASE_SUFFIX}@example.com"
...
# Then — The registration is created and can be read back from the event registrations endpoint.
[ "$HTTP_STATUS" = "201" ]
