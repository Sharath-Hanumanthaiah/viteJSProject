...
test("Signup Form Rejects When Password Is Missing", async ({ page }, testInfo) => {
  const recorder = new ExecutionRecorder({
    testId: "signup_missing_password",
    testName: "Signup Form Rejects When Password Is Missing",
  });
  ...
  try {
    ...
    await recorder.step("Fill required fields except password", async () => {
    ...
    await recorder.step("Verify password validation blocks submission", async () => {
