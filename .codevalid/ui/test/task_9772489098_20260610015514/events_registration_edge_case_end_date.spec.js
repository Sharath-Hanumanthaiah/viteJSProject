...
test("Registration Allowed On Event End Date", async ({ page }, testInfo) => {
  const recorder = new ExecutionRecorder(TEST_ID, "Registration Allowed On Event End Date");

  await recorder.step("Freeze browser date to the event end date and seed authenticated session");
